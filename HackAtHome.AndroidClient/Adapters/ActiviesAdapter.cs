...
namespace HackAtHome.AndroidClient.Adapters
{
    public class ActiviesAdapter : BaseAdapter<Evidence>
    {
        ...
        public ActiviesAdapter(Activity context, List<Evidence> evidences, int itemLayoutTemplate, int evidenceTitleViewID, int evidenceStatusViewID)
        {
